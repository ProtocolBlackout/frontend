...
export default function Gamespage() {
    ...
    const games = [
...

        {
            ...
            desc: 'Erkenne gefährliche Phishing-Mails und schütze dich vor Betrug',
            instructions: [
                'Seite 1: Lese jede E-Mail sorgfältig durch.',
                'Seite 2: Entscheide, ob es sich um Phishing handelt oder eine legitime Mail ist.',
                'Seite 3: Bei Phishing: Markiere die verdächtigen Merkmale.'
            ],
